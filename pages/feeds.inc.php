...
<ul class="feedlist">
	...
	foreach ($lifestream->feeds as $identifier=>$class_name)
	{
		...
		?><li><a href="?page=lifestream.php&amp;op=add&amp;feed=<?php echo urlencode($identifier); ?>" title="<?php echo htmlspecialchars($result->get_constant('NAME')); ?>"><img src="<?php echo $result->get_icon_url(); ?>" width="16" height="16"/> <?php echo htmlspecialchars($result->get_constant('NAME')); ?></a></li><?php
	}
	?>
</ul>
