...
if (count($events))
{
    ...
    foreach ($events as $result)
    {
        ...
        ?>
        <li class="lifestream_feedid_<?php echo $result->feed->get_constant('ID'); ?> lifestream_feed_<?php echo $result->feed->get_constant('ID'); ?>" style="background-image: url('<?php echo $result->feed->get_icon_url(); ?>');">
